...
#Note: Save the images("img") folder and the python file in the same directory.
...
#This function reads the images fro the "img" folder and detects the blob present in the image using
